...
s = 1
init_com = "This program gives the sum of first 'n' odd numbers, 'n' given by your input."
...
# This program gives the sum of first 'n' odd numbers, 'n' given by your input.
# Type a number: 3
# Sum of first 3 odd numbers is: 9
# Try once more?
# Type a number: 1
# Sum of first 1 odd numbers is: 1
# Try once more?
# Type a number: 0
